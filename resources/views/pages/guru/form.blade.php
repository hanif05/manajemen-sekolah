            ...
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="#">Tambah Guru</a></li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="form-material m-t-40" action="{{ route('guru.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label>Nama:</label>
                                <input type="text" class="form-control form-control-line" name="nama" required placeholder="Masukan Nama Guru">
                            </div>
                            <div class="form-group">
                                <label>Email:</label>
